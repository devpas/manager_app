...
class TaxCusCategoriesDesktopPage extends ConsumerStatefulWidget {
  const TaxCusCategoriesDesktopPage({Key? key}) : super(key: key);

  @override
  ConsumerState<TaxCusCategoriesDesktopPage> createState() => _TaxCusCategoriesDesktopPageState();
}

class _TaxCusCategoriesDesktopPageState extends ConsumerState<TaxCusCategoriesDesktopPage> with TickerProviderStateMixin {
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Row(children: [
                  SizedBox(width: screenWidth * 0.28, child: Text("0/${state.taxCusCategories!.length}")),
                  SizedBox(
                    child: Row(children: [
                      20.horizontalSpace,
                      CircleIconButton(
                      ...
                      : Padding(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              var taxCusCategory = state.taxCusCategories![index];
                              taxCusCategory = state.taxCusCategories![index];
