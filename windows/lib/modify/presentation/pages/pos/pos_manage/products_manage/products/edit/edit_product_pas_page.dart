...
import 'package:g_manager_app/src/riverpod/states/states.dart';
...
import 'widgets/search_discount_modal_in_edit_product.dart';
...
class _EditProductPasPage extends ConsumerState<EditProductPasPage> with TickerProviderStateMixin {
  ...
  _EditProductPasPage(this.productData);
