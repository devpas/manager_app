...
class DeleteTaxCategoryDialog extends ConsumerWidget {
  final String alias;

  const DeleteTaxCategoryDialog({Key? key, required this.alias}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AbsorbPointer(
      ...
      child: AlertDialog(
        title: Text(
          'Bạn có muốn xóa mục chiếc khấu này?',
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              notifier.deleteTaxCategory(alias);
              context.popRoute();
            },
            child: Text(
