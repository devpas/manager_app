...
class DeleteTaxDialog extends ConsumerWidget {
  final String alias;

  const DeleteTaxDialog({Key? key, required this.alias}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AbsorbPointer(
      ...
      child: AlertDialog(
        title: Text(
          'Bạn có muốn xóa chiếc khấu này?',
