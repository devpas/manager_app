          ...
          child: Column(
            ...
            children: [
              ...
              SelectWithAddButton(
                ...
                title: taxCusCategoryName == "" ? (state.taxCusCategories!.where((e) => e["id"] == customer.taxCusCategory).length > 0 ? state.taxCusCategories!.where((e) => e["id"] == customer.taxCusCategory).first["name"] : "") : taxCusCategoryName,
                onSelectTap: () {
