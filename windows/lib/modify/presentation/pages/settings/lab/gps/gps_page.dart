...
class GPSTrackerPage extends ConsumerStatefulWidget {
  const GPSTrackerPage({Key? key}) : super(key: key);

  @override
  ConsumerState<GPSTrackerPage> createState() => _GPSTrackerPageState();
}

class _GPSTrackerPageState extends ConsumerState<GPSTrackerPage> {
  @override
  void initState() {
    super.initState();
    Future.delayed(
