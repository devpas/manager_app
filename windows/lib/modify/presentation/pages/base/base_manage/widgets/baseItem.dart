                ...
                title: Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          "Vốn đầu ngày: ${base.moneyRecord["total_money_day_start"]}",
                          style: const TextStyle(color: Colors.black),
                        ),
                      ],
                    )
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        SizedBox(
                          width: screenWidth * 0.425,
                          child: Text("Tổng tiền hàng: ${base.moneyRecord["total_money_product"]}"),
                        ),
                        SizedBox(
                          width: screenWidth * 0.425,
                          child: Text("Tổng công nợ: ${base.moneyRecord["money_sold"]}"),
                        ),
                      ],
                    ),
                  ),
