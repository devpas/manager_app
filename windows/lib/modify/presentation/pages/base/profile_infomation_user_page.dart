...
class ProfileInfomationUserPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProfileInfomationUserPage> createState() => _ProfileInfomationUserPageState();
}

class _ProfileInfomationUserPageState extends ConsumerState<ProfileInfomationUserPage> {
  @override
  void initState() {
    super.initState();
    Future.delayed(
