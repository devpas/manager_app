...
class _$AddProductStateImpl extends _AddProductState {
  ...
  @override
  String toString() {
    return 'AddProductState(isSaving: $isSaving, active: $active, isShopSearching: $isShopSearching, isBrandSearching: $isBrandSearching, isCategorySearching: $isCategorySearching, name: $name, description: $description, shopQuery: $shopQuery, brandQuery: $brandQuery, categoryQuery: $categoryQuery, tax: $tax, minQuantity: $minQuantity, maxQuantity: $maxQuantity, searchedShops: $searchedShops, searchedBrands: $searchedBrands, searchedCategories: $searchedCategories, selectedShop: $selectedShop, selectedBrand: $selectedBrand, selectedCategory: $selectedCategory, image: $image)';
  }
