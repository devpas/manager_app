...
mixin _$EditCategoryState {
  ...
  int get selectedParentId => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      selectedParentId: null == selectedParentId
          ? _value.selectedParentId
          : selectedParentId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$_EditCategoryState extends _EditCategoryState {
  ...
  @override
  String toString() {
    return 'EditCategoryState(isLoading: $isLoading, isSaving: $isSaving, status: $status, isSearching: $isSearching, name: $name, description: $description, query: $query, keywords: $keywords, searchedCategories: $searchedCategories, selectedParentId: $selectedParentId, parentCategory: $parentCategory, imageUrl: $imageUrl, image: $image)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.selectedParentId, selectedParentId) ||
                other.selectedParentId == selectedParentId) &&
