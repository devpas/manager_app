...
class _$AddCategoryStateImpl extends _AddCategoryState {
  ...
  @override
  String toString() {
    return 'AddCategoryState(isLoading: $isLoading, isSaving: $isSaving, status: $status, isSearching: $isSearching, name: $name, description: $description, query: $query, keywords: $keywords, searchedCategories: $searchedCategories, selectedParentId: $selectedParentId, parentCategory: $parentCategory, image: $image)';
  }
