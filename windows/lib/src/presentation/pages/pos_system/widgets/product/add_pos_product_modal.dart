...
class AddPosProductModal extends ConsumerStatefulWidget {
  final ProductData? product;

  const AddPosProductModal({Key? key, required this.product}) : super(key: key);

  @override
  ConsumerState<AddPosProductModal> createState() => _AddPosProductModalState();
}

class _AddPosProductModalState extends ConsumerState<AddPosProductModal> {
  @override
  void initState() {
    super.initState();
    Future.delayed(
      Duration.zero,
      () {
        ref.read(addPosProductProvider.notifier).setProduct(widget.product);
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(addPosProductProvider);
    final notifier = ref.read(addPosProductProvider.notifier);
